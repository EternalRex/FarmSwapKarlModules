...
class AdminRegisterDateUpdate extends StatefulWidget {
  AdminRegisterDateUpdate(
  ...
  @override
  State<AdminRegisterDateUpdate> createState() =>
      _AdminRegisterDateUpdateState();
}

class _AdminRegisterDateUpdateState extends State<AdminRegisterDateUpdate> {
//Class Objects
    ...
    return GestureDetector(
      ...
      onTap: () {
        showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              title: const Text("Enter Register Date"),
