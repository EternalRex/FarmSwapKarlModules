...
//class objects
  ...
  Future<void> adminDateFields(String? value, DateTime newDate, String userid) async {
    switch (value) {
      case "birthdate":
        await update.getUpdateDocId(userid);
        final documentref = FirebaseFirestore.instance.collection('Users').doc(update.mydocid);
